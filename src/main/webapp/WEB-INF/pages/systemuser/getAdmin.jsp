...
<link rel="stylesheet" type="text/css" href="css/back.css">
 <script type="text/javascript">
			$(function(){
				...
				$("#fn-btn-edit").click(function (){
					location.href ="toModifyPass.do";
					alter("oooooooo");
				});
...
<body style="overflow: hidden;">
	 <div class="header" style="left: 0;top: 0;width: 100%;">
		...
		<form  action="showUserAudit.do" method="post">
			<table style="padding-top: 40px;" align="center">
				...
				<tr><td>邮箱：</td>
					<td><input type="text" disabled="disabled" name="email" value="${sessionScope.systemUser.email}"></td>
				</tr>
				<tr><td>手机：</td>
					<td><input type="text" disabled="disabled" name="telephone" value="${sessionScope.systemUser.telephone}"></td>
				</tr>
				<tr><td>备用电话：</td>
					<td><input type="text" disabled="disabled" name="cellphone" value="${sessionScope.systemUser.cellphone}"></td>
				</tr>
				<tr>
