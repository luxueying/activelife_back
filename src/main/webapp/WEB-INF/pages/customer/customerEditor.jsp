...
$(document).ready(function() {
   ...
   //输入框
        ...
        $("#fileUpload").click(function() {
            ...
            var url = "uploadcustomerImage.do?imageType=" + imageType + "&&customerId=" + customerId;
        ...
        $("#deleteImage").click(function() {
            ...
            var option = {
                ...
                buttons : {
                    "确定" : function() {
                        activelife_submit.submit("deletecustomerImage.do", data, entry, afterDeleteImage);
                        $(this).dialog("close");
                    }
                }
            };
                ...
                <input name="id" type="hidden" value="<%=id%>" />
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="userName"  class="generic_input"  value="${customer.realName}" /></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="phoneNumber" class="generic_input" value="${customer.phoneNumber}" /></td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><select name="countryCode" class="generic_select" id="countryCode">
                                    ...
                                    <c:forEach items="${countryList}" var="country">
                                        <c:if test="${customer.countryCode == country.countryCode}">
                            ...
                            </select> <input type="hidden" name="customerId" value="${customer.customerId}" /></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td><select name="provinceCode" class="generic_select" id="provinceCode">
                                    ...
                                    <c:forEach items="${provinceList}" var="province">
                                        <c:if test="${customer.provinceCode == province.provinceCode}">
                        ...
                        <tr>
                            ...
                            <td><select name="cityCode" class="generic_select" id="cityCode">
                                    ...
                                    <c:forEach items="${cityList}" var="city">
                                        <c:if test="${customer.cityCode == city.cityCode}">
                        ...
                        <tr>
                            ...
                            <td><select name="countyCode" class="generic_select" id="countyCode">
                                    ...
                                    <c:forEach items="${countyList}" var="county">
                                        <c:if test="${customer.countyCode == county.countyCode}">
                ...
                <form>
                    <table>
                        <tr>
                            ...
                            </select> <input type="hidden" name="customerId" value="${customer.customerId}" id="customerId" /></td>
